<footer class="text-light py-5 gradient-bg mt-5" style="background: linear-gradient(90deg, #e8a9bb 0%, #99bbe8 100%)">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <h3 class="text-light"><i class="bi-back"></i> Kiến thức 4.0</h3>
                <!-- Sử dụng text-warning để giả lập màu cam -->
            ...
            <div class="col-md-4">
                ...
                <div>
                    <a href="https://www.facebook.com/anh.hong.594371" class="me-2 text-primary"><i
...
<a href="#" class="btn btn-primary rounded-circle back-to-top" id="back-to-top"
