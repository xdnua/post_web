<?php include __DIR__ . '/../../controllers/connect.php'; ?>
...
<body style="padding-top: 60px;">
    ...
    <div class="container mt-5">
        <h2 class="text-center mb-4"><i class="bi bi-stars text-primary"></i> Giới thiệu về <strong>Kiến thức
                4.0</strong></h2>
        <p class="text-center lead mb-5">Nơi bạn có thể học, chia sẻ và phát triển nghề nghiệp trong lĩnh vực
            <strong>kiểm thử phần mềm</strong>.
        </p>

        <div class="text-center mb-5">
            <img src="<?= $baseUrl ?>/src/assets/uploads/dao-tao-tester-1.png" alt="Học kiểm thử phần mềm"
            ...
            <div class="col-md-6">
                <div class="card h-100 border-0 shadow position-relative overflow-hidden custom-hover-card">
                    <div class="card-body text-center">
                        ...
                        <p>Bạn có thể bắt đầu bằng cách đọc <a href="<?= $baseUrl ?>/index.php"
                                class="link-primary fw-semibold"> Bài viết mới nhất</a>, hoặc <a
                                href="<?= $baseUrl ?>/src/views/post/create_post.php"
                                class="link-success fw-semibold">Gửi bài chia
                                sẻ</a> nếu bạn cũng đam mê kiểm thử!<br>Cảm ơn bạn đã ghé thăm! <i
                                class="bi bi-emoji-smile text-warning"></i></p>
                    </div>
