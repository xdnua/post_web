...
<body style="padding-top: 60px;">
                ...
                <div class="col-12">
                    <form method="GET" action="" class="d-flex justify-content-center">
                        <div class="input-group input-group-lg rounded-pill shadow-sm overflow-hidden"
                            style="max-width: 600px; border: 1px solid white;">
                            <span class="input-group-text border-0"><i class="bi bi-search"></i></span>
                            <input type="text" class="form-control border-0 ps-1" name="search"
                            ...
                            <?php endif; ?>
                            <button class="btn btn-primary text-white px-4 border-0" type="submit"
                                style="border: none !important;">Tìm kiếm</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="card card-hover h-100 featured-card shadow-sm"
                        ...
                        <div class="card-body">
                            <div class=" card-body d-flex flex-column">
                                ...
                                <p class="card-text text-light">Chào mừng bạn đến với Kiến thức 4.0! Nơi chia sẻ kiến
                                    thức và kinh nghiệm về kiểm thử phần mềm và nhiều chủ đề thú vị khác.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class=" card card-hover h-100 featured-card shadow-sm"
                        ...
                        <div class="card-body">
                            <div class="  card-body d-flex flex-column">
                                ...
                                <p class="card-text text-light" style="height: 200px;">Kiến thức 4.0 là nền tảng chia sẻ
                                    kiến thức trực tuyến, nơi bạn có thể tìm thấy các bài viết chất lượng về kiểm thử
                                    phần mềm và nhiều lĩnh vực khác. Chúng tôi cung cấp môi trường học tập và chia sẻ
                                    kiến thức cho cộng đồng.</p>
    ...
    <section class="topics-section py-5">
        <div class="container">
            ...
            <!-- Topic Tabs -->
            <div
                style="overflow-x: auto; white-space: nowrap; padding-bottom: 15px; -webkit-overflow-scrolling: touch;">
                <ul class="nav nav-tabs border-0 mb-4" id="topicTabs" role="tablist"
                    style="display: flex; flex-wrap: nowrap; overflow-x: auto; white-space: nowrap; max-width: 100vw; min-width: 0; justify-content: flex-start; padding: 0;">
                    <!-- <?php if (!empty($topics)): ?>
    <?php /*
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        <li class="page-item<?php if ($page <= 1)
                            echo ' disabled'; ?>">
                            <a class="page-link"
                                href="?page=<?php echo $page - 1; ?><?php echo !empty($search_term) ? '&search=' . htmlspecialchars($search_term) : ''; ?><?php echo ($topic_id !== null) ? '&topic_id=' . htmlspecialchars($topic_id) : ''; ?>"
                                tabindex="-1">&laquo;</a>
                        </li>
                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                            <li class="page-item<?php if ($i == $page)
                                echo ' active'; ?>">
                                <a class="page-link"
                                    href="?page=<?php echo $i; ?><?php echo !empty($search_term) ? '&search=' . htmlspecialchars($search_term) : ''; ?><?php echo ($topic_id !== null) ? '&topic_id=' . htmlspecialchars($topic_id) : ''; ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>
                        <li class="page-item<?php if ($page >= $total_pages)
                            echo ' disabled'; ?>">
                            <a class="page-link"
                                href="?page=<?php echo $page + 1; ?><?php echo !empty($search_term) ? '&search=' . htmlspecialchars($search_term) : ''; ?><?php echo ($topic_id !== null) ? '&topic_id=' . htmlspecialchars($topic_id) : ''; ?>">&raquo;</a>
                        </li>
                    </ul>
                </nav>
            <?php endif; ?>
                    ...
                    <div class="timeline-how-it-works">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content text-dark">
                                ...
                                <p>Bắt đầu hành trình khám phá kiến ​​thức của bạn bằng cách sử dụng thanh tìm kiếm
                                    thông minh hoặc duyệt qua các danh mục đa dạng. Hệ thống của chúng tôi được thiết kế
                                    để giúp bạn dễ dàng tìm thấy các bài viết, tài liệu hoặc khóa học phù hợp nhất với
                                    sở thích và nhu cầu học tập của bạn, từ cơ bản đến nâng cao.</p>
                            </div>
                        </div>
                        <!-- Step 2 -->
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content text-dark">
                                ...
                                <p>Bạn tìm thấy điều gì đó hữu ích nhưng không có thời gian để đọc ngay? Đừng lo! Chỉ
                                    với một cú nhấp chuột, bạn có thể dễ dàng đánh dấu trang các bài viết yêu thích của
                                    mình. Tất cả các dấu trang được lưu trữ an toàn trong thư viện cá nhân của bạn, giúp
                                    bạn dễ dàng quay lại và tiếp tục học bất cứ lúc nào.</p>
                            </div>
                        </div>
                        <!-- Step 3 -->
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content text-dark">
                                <h4>Đọc & Tận hưởng</h4>
                                <p>Đắm mình vào thế giới tri thức với giao diện đọc thân thiện với người dùng và được
                                    tối ưu hóa. Tận hưởng trải nghiệm học tập liền mạch, không bị gián đoạn, với các
                                    nguồn tài nguyên được trình bày rõ ràng và hấp dẫn. Dành thời gian để tiếp thu kiến
                                    ​​thức mới và áp dụng vào thực tế, làm phong phú thêm sự hiểu biết của bạn.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    Kiểm thử phần mềm là quá trình đánh giá và xác minh rằng một sản phẩm phần mềm thực
                                    hiện đúng như mong đợi. Mục tiêu chính là phát hiện lỗi, đảm bảo chất lượng và tăng
                                    độ tin cậy của sản phẩm trước khi đưa vào sử dụng thực tế. Đây là một bước không thể
                                    thiếu trong quy trình phát triển phần mềm để đảm bảo trải nghiệm người dùng tốt
                                    nhất.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Để bắt đầu với kiểm thử phần mềm, bạn nên tìm hiểu các kiến thức cơ bản về quy trình
                                    kiểm thử, các loại kiểm thử (kiểm thử thủ công, kiểm thử tự động, hồi quy, v.v.) và
                                    các công cụ phổ biến. Thực hành viết test case, báo cáo lỗi và làm quen với các môi
                                    trường phát triển là rất quan trọng. Có nhiều khóa học trực tuyến và tài liệu miễn
                                    phí có thể giúp bạn khởi đầu.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Chi phí học kiểm thử phần mềm có thể rất đa dạng, từ miễn phí đến hàng chục triệu
                                    đồng, tùy thuộc vào phương pháp học và nguồn tài liệu bạn chọn. Có rất nhiều tài
                                    nguyên trực tuyến miễn phí như bài viết, video, và các khóa học giới thiệu. Nếu bạn
                                    muốn theo đuổi các chứng chỉ chuyên nghiệp hoặc các khóa học chuyên sâu tại các
                                    trung tâm đào tạo, chi phí sẽ cao hơn.
                                </div>
                            </div>
                        </div>
                    </div>
